...
export class AddIncomePopUp{
    ...
    public get navContainer(): Locator{
        return this.page.locator('table.MuiTable-root[id="add-new-income"]');
    }
    ...
    public get incomeInput(): Locator {
        return this.page.locator('input.MuiInput-input[id="Income-New"]');
    }
